    ...
    <div id="branches" class="tab-pane p-0 container">
                    ...
                    <div class="card-header bg-white p-3" role="tab">
                        <a data-toggle="collapse" data-parent="#accordionBank" href=".collapseBank" aria-expanded="true"
                            ...
                            <h5 class="mb-2 px-0 border-bottom-0">
                                Branches Information <span><small>(Optional)</small></span>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="container">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                                                <div class="form-group">
                                                                                    <label>Address</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Provide more details about your branches 'If any'">
...
<script>
    $('#branchform')
        .ajaxForm({
            url : $('#branchform').attr('action'), // or whatever
            type : $('#branchform').attr('method'), // or whatever
            dataType : 'json',
    ...
    $(document).on('change', '.country_id', function(e){
        var id = $(this).val();
        var that = $(this);
        var citySelect = that.parent().parent().next().next().children().children()[1];
