                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div >
                            ...
                            <p class="font-weight-bold pt-3 reviewText">Please fill out all the required fields in order to submit your data. Here are what is missing:</p>
                            <div id="errorList">
                            </div>
                        </div>
                    </div>
    ...
    <div class="container pt-4 d-none" id="SuccessBtn">
        <p class="text-center"><a href="{{ URL::to('supplier/submit') }}" class="btn btnSubmitDataSuccess"> Submit </a>
        </p>
    </div>
</div>
<script></script>
