        ...
        <div class="container">
            ...
            <div class="tabButton" >
                <ul class="nav nav-pills text-white bg-dark flex-column flex-md-row nav-justified">
                    ...
                    <li class="nav-item border-right"><a class="nav-link" data-toggle="pill" href="#branches"> Branches
                        </a></li>
            ...
            <div class="tab-content">
                @include('supplier.registers.companyData')

                @include('supplier.registers.branches')
                
                @include('supplier.registers.banks')
                
                @include('supplier.registers.activity')

                @include('supplier.registers.document')

                @include('supplier.registers.submit')
