...
@endpush
    ...
    <div id="activities" class="tab-pane p-0 container pb-4">
                                        ...
                                        <div class="addDetails p-2">
                                            <div class="container">
                                                ...
                                                <div class="actCard px-5" style="display:none;">
                                                                ...
                                                                <div class="projectRow">
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-6 ">
                                                                                <div class="form-group">
                                                                                    <label> Company</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                                                    <i class="far fa-question-circle"></i></span>
                                                                                    <input type="text" name="activity[0][projectComNames][]" value="" class="form-control" placeholder="Type Your Company"
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 ">
                                                                                <div class="form-group">
                                                                                    <label>Location</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                                                    <i class="far fa-question-circle"></i></span>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 ">
                                                                                <div class="form-group">
                                                                                    <label>Phone Number</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                                                    <i class="far fa-question-circle"></i></span>
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 ">
                                                                                <div class="form-group">
                                                                                    <label>Project Title</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                                                    <i class="far fa-question-circle"></i></span>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 ">
                                                                                <div class="form-group">
                                                                                    <label>Project Purpose</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                                                    <i class="far fa-question-circle"></i></span>
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 ">
                                                                                <div class="form-group">
                                                                                    <label>Contract Value</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                                                    <i class="far fa-question-circle"></i></span>
                                                                                    <input type="number" step="0.1" name="activity[0][projectcontract_values][]" value="0" class="form-control" placeholder="Add the Contract Value"
                                                                                        aria-describedby="helpId">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6">
                                                                                <div class="form-group">
                                                                                    <label>Upload Supporting documents</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                                                    <i class="far fa-question-circle"></i></span>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6">
                                                                                <label>Allocated Scope</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 specify d-none">
                                                                                <label>Specify</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                                                    <i class="far fa-question-circle"></i></span>
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 specify d-none">
                                                                                ...
                                                                                <input type="number" name="activity[0][projectawarded_values][]" value="" class="form-control" placeholder="Add the awarded value"
                                                                                        aria-describedby="helpId">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <button type="button" onclick="addproject('#activity_0')" data-actId="0" class="btn btnClickAddAccount mt-1"><i class="fa fa-plus-circle"></i> Add more projects</button>
                                                </div>
...
<script>
    ...
    $(document).on("change",".uploadSimilarFile",function(evt){
        ...
        for (let i = 0, file; file = files[i]; i++) {
            ...
            if(size < 5 && (GlobalFiles[activity_num][project_num].length + $('.oldfile_'+activity_num+'_'+project_num).length ) < 3){
                GlobalFiles[activity_num][project_num].push(file);
            }
            else{
                alert('We support pdf only (up to 3 files) . Make sure that your files are not more than 5 MB.');
        ...
        for(let i in GlobalFiles[activity_num][project_num]){
            ...
            if(file){
                ...
                if(size < 5){
                    html += ` <h6>
                        <span>${file.name}</span>
                        <span class="float-right">${size} MB <i class="far fa-trash-alt text-danger hand deleteFile" data-fileid="${i}" data-activitynum="${activity_num}" data-projectnum="${project_num}"></i></span>
                                                                    ...
                                                                    '<div class="card-body">'+
                                                                        '<div class="row">'+
                                                                            '<div class="col-lg-6 col-md-6 ">'+
                                                                                '<div class="form-group">'+
                                                                                    '<label> Company</label>'+
                                                                                    '<input type="text" name="activity['+activitycount+'][projectComNames][]" value="" class="form-control" placeholder="Type Your Company"'+
                                                                                        'aria-describedby="helpId">'+
                                                                                '</div>'+
                                                                            '</div>'+
    ...
    function addproject(DivId){
        ...
        let projectsCount = $('.orderProject_'+ActivityNum).length;
                            ...
                            '<div class="card-body">'+
                                '<div class="row">'+
                                    '<div class="col-lg-6 col-md-6 ">'+
                                        '<div class="form-group">'+
                                            '<label> Company</label>'+
                                            '<input type="text" name="activity['+ActivityNum+'][projectComNames][]" value="" class="form-control" placeholder="Type Your Company" aria-describedby="helpId">'+
                                        '</div>'+
                                    '</div>'+
                                ...
                                '<div class="row">'+
                                    ...
                                    '<div class="col-lg-6 col-md-6">'+
                                        '<div class="form-group">'+
                                            '<label>Upload Supporting documents</label>'+
                                            '<input type="file" accept=".pdf" name="activity['+ActivityNum+'][similarFiles]['+(projectsCount+1)+'][]" data-project="'+ (projectsCount+1) +'" data-id="'+ActivityNum+'" class="form-control uploadSimilarFile" placeholder="Upload Supporting documents"'+
                                                'aria-describedby="helpId" >'+
                                                '<div class="editUploadFile mt-4">'+
                                                '</div>'+
                                        '</div>'+
