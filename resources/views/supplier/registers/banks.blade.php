    ...
    <div id="bankAcc" class="tab-pane p-0 container">
                                        ...
                                        @foreach ($user->banks as $key =>$bank)
                                            @if ($key == 0)
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                        <div class="form-group">
                                                            <label>Name</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Provide your bank name. Make sure that all details are accurate.">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                        <div class="form-group">
                                                            <label>Country</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Choose the country of this bank">
                                                        <i class="far fa-question-circle"></i></span>
                                                    ...
                                                    <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                        <div class="form-group">
                                                            <label>Account Number</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Make sure to provide the accurate 'Account Number' because that may affect your payments">
                                                        <i class="far fa-question-circle"></i></span>
