...
<div id="companyDetails" class="tab-pane container p-0 fade active show {{ $user->expireDocuments() ? 'disableAll':'' }}" >
    <form method="POST" action="{{ URL::to('supplier') }}" id="companyForm">
        {{ csrf_field() }}
                        ...
                        <div class="addDetails py-2 px-3">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-5 ">
                                        <div class="form-group">
                                            <label>Commercial Name</label> <span class="float-right"></span>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-5 col-sm-5 mt-2 mb-2 phoneNum">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control col-8 float-right" type="number" name="phone" pattern="[1-9]+" title="Please add numbers only"
                                    ...
                                    @foreach ($user->contactPersons as $key => $contactPerson)
                                        @if ($key ==0)
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                    <div class="form-group">
                                                        <label>Contact Person </label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                        <i class="far fa-question-circle"></i></span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                    <div class="form-group">
                                                        <label>Email</label>
                                                        <input value="{{ $contactPerson->email ?? '' }}" name="person[email][]" type="email"  class="form-control" placeholder="Add your company Email"
                                                            aria-describedby="helpId">
                                                    </div>
                                                </div>
                                                <div class="col-lg-2 col-sm-1 col-md-1"></div>
                                                                    ...
                                                                    <div class="container">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                                                <div class="form-group">
                                                                                    <label>Fax Number</label><span class="float-right"><small>(Optional)</small></span>
                                                                                    <input type="number" pattern="[0-9]{9}" value="{{ $contactPerson->fax ?? '' }}" name="person[fax][]" class="form-control" placeholder="Add your company phone"
                                                                                        aria-describedby="helpId">
                                                                                </div>
                                                                            </div>
                                ...
                                @else
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                <div class="form-group">
                                                    <label>Contact Person <span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                <div class="form-group">
                                                    <label>Email</label>
                                                    <input name="person[email][]" type="email"  class="form-control" placeholder="Add your company Email"
                                                        aria-describedby="helpId">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-sm-1 col-md-1"></div>
                                        ...
                                        @foreach ($user->agents as $key => $agent)
                                            @if ($key == 0)
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                        <div class="form-group">
                                                            <label>Agent Name</label><span class="float-right" data-toggle="tooltip" style="cursor:pointer" data-placement="top" title="Hover over the buttons below to see the directions">
                                                        <i class="far fa-question-circle"></i></span>
            ...
            .ajaxForm({
                ...
                success : function (response) {
                    ...
                    if(response.success){
                        ...
                        $('a[href="#bankAcc"]').click();
                        window.location.hash = 'bankAcc';
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5 col-md-5 col-sm-5 ">
                                                    <div class="form-group">
                                                        <label>Fax Number</label><span class="float-right"><small>(Optional)</small></span>
                                                        <input type="number" pattern="[0-9]{9}"  class="form-control" placeholder="Add your company phone"
                                                            aria-describedby="helpId">
                                                    </div>
                                                </div>
