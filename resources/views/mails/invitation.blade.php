    ...
    <div style="padding: 0rem;">
        ...
        border-top: 2px solid #F39201;">
            <div style="background-color: rgba(243,243,243,0.8);">
                <table>
                    <td><img src="{{ $url }}/images/sumed.png" style="padding: 1rem 2rem;"></td>
            ...
            <p style="font-size: 12px;padding-bottom: 1rem;">This is an automatically generated email, please do not reply. For any inquiries <a href="{{  $url}}/supplier/contactus }}">Contact Us</a></p>
